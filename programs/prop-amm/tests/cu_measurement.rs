...
const PROP_AMM_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../../target/deploy/prop_amm"
);
...
impl SwapSetup {
    ...
    fn build_accounts(&self, aux: &PropAmmAux) -> Vec<(Address, Account)> {
        ...
        vec![
            ...
            (self.user_base_key, create_token_account(&self.base_mint_key, &self.user, 100_000_000_000)),
            (self.user_quote_key, create_token_account(&self.quote_mint_key, &self.user, 100_000_000_000)),
            (self.base_vault_key, create_token_account(&self.base_mint_key, &self.pool_pda, 100_000_000_000)),
            (self.quote_vault_key, create_token_account(&self.quote_mint_key, &self.pool_pda, 100_000_000_000)),
            ...
            (SPL_TOKEN_ID, create_program_account_loader_v3(&SPL_TOKEN_ID)),
...
fn read_aux_from_result(result: &mollusk_svm::result::InstructionResult, envelope_key: &Address) -> PropAmmAux {
...
fn test_swap_credit_model() {
    ...
    println!("  After buy: ask_acc={}, bid_credit={}", expected_ask_accumulated_after_buy, expected_bid_credit_after_buy);
    println!("  After sell: bid_acc={}, ask_credit={}, ask_acc={}",
    ...
    println!("  quote_received={}, base_used={}", quote_received, base_used);
    println!("========================================");
}
